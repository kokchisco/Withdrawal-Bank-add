		...
		if (isset($shonupost['language']) || isset($shonupost['payTypeId']) || isset($shonupost['payid']) || isset($shonupost['random']) || isset($shonupost['signature']) || isset($shonupost['timestamp'])) {
			...
			if($shonusign){
				...
				if($data_auth['status'] === 'Success') {
					...
					if($sesnum == 1){
						$sites = 'https://betall.it.com';
						
						if ($payid == 2) {
                            $data["rechargetypelist"]["0"]["payTypeID"] = (int)"1023";
                            $data["rechargetypelist"]["0"]["payID"] = (int)"2";
                            $data["rechargetypelist"]["0"]["payName"] = "Bank transfer";
                            $data["rechargetypelist"]["0"]["paySysName"] = "923";
                            $data["rechargetypelist"]["0"]["miniPrice"] = (int)"5000";
                            $data["rechargetypelist"]["0"]["maxPrice"] = (int)"500000";
                            $data["rechargetypelist"]["0"]["scope"] = "5000|10000|20000|50000|100000|500000";
                            ...
                            $data["rechargetypelist"]["0"]["quickConfigList"] = [
                                ...
                                ["rechargeAmount" => 500000.0, "giftAmount" => 0.0],
                            ...
                            $data["rechargetypelist"]["1"]["payName"] = "Online Transfer";
                            $data["rechargetypelist"]["1"]["paySysName"] = "923";
                            $data["rechargetypelist"]["1"]["miniPrice"] = (int)"500000";
                            $data["rechargetypelist"]["1"]["maxPrice"] = (int)"5000000";
                            $data["rechargetypelist"]["1"]["scope"] = "501000|750000|900000|1500000|3000000|50000000";
                            ...
                            $data["rechargetypelist"]["1"]["quickConfigList"] = [
                                ["rechargeAmount" => 501000.0, "giftAmount" => 00.0],
                                ["rechargeAmount" => 750000.0, "giftAmount" => 0.0],
                                ["rechargeAmount" => 900000.0, "giftAmount" => 0.0],
                                ["rechargeAmount" => 1500000.0, "giftAmount" => 0.0],
                                ["rechargeAmount" => 3000000.0, "giftAmount" => 0.0],
                                ["rechargeAmount" => 5000000.0, "giftAmount" => 0.0],
                            ];
